        ...
        <div className="flex items-center justify-center min-h-[80vh]">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-primary bg-clip-text text-transparent animate-glow"
            >
              Mubashir Awan
            </motion.h1>
            ...
            <motion.h2
              ...
              className="text-xl md:text-3xl lg:text-4xl font-semibold text-foreground"
            >
